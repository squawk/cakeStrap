...
<?php echo "<?php endif; ?>\n\n"; ?>
	<div class="actions">
		<ul style="list-style: none;">
			<li><?php echo "<?php echo \$this->Html->link(__('New " . Inflector::humanize(Inflector::underscore($alias)) . "'), array('controller' => '{$details['controller']}', 'action' => 'add'), array('class' => 'btn btn-primary btn-mini')); ?>"; ?> </li>
		</ul>
	</div>
</div>
<?php endforeach; ?>
